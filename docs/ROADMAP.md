...
| 3.4 — Payment link (jasa website + langganan medsos) | 🟡 Draf ADR dibuat, menunggu keputusan Andri | Draf `docs/adr/0001-payment-link.md` — opsi: (a) manual WA, (b) Mayar.id, (c) Lynk.id. Keputusan provider/fee wajib approval Andri (`AI-GOVERNANCE.md` §1). |
