...
export const URUSAN = [
  ...
  { kode: '4.01', nama: 'Sekretariat Daerah (Unsur Pendukung)' },
  { kode: '4.02', nama: 'Sekretariat DPRD (Unsur Pendukung)' },
  { kode: '5.01', nama: 'Perencanaan (Unsur Penunjang)' },
  { kode: '5.02', nama: 'Keuangan (Unsur Penunjang)' },
  { kode: '5.03', nama: 'Kepegawaian serta Pendidikan dan Pelatihan (Unsur Penunjang)' },
  { kode: '5.04', nama: 'Penelitian dan Pengembangan (Unsur Penunjang)' },
  { kode: '5.05', nama: 'Unsur Penunjang Lainnya' },
  { kode: '6.01', nama: 'Inspektorat Daerah (Unsur Pengawasan)' },
  { kode: '7.01', nama: 'Kecamatan (Unsur Kewilayahan)' },
  { kode: '8.01', nama: 'Kesatuan Bangsa dan Politik (Pemerintahan Umum)' },
];
